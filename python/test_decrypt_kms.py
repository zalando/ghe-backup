...
def test_aws_decrypt(toencrypt="BCDE"):
    print("\ntoencrypt: {}\n".format(toencrypt))
    encryption_res = decrypt_kms.aws_encrypt(key_id="b44f5008-cebc-4cba-b677-02c938f7a197", to_encrypt=toencrypt)
    print("encryption_res: ", encryption_res)
    decryption_res = decrypt_kms.aws_decrypt(to_decrypt=encryption_res)
